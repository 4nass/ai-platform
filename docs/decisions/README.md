...
| [ADR-007](ADR-007-preview-environments.md) | Immutable per-run preview environments | Accepted |
...
| [ADR-015](ADR-015-managed-wsl-service.md) | Optional local WSL2 user service with health and backups | Accepted |
