...
| P2 | Reliable WSL service mode | [#40](https://github.com/4nass/ai-platform/issues/40) | Delivered in engine: worker loop, local health, WAL-aware backup/restore and systemd templates; host enablement remains operator-specific |
